...
public class DatePreferenceDialogFragment extends PreferenceDialogFragmentCompat {
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            ...
            String dateVal = mLastYear + "-" + mLastMonth + "-" + mLastDay;
            ...
            result.putString("birth", dateVal);
            this.getParentFragmentManager().setFragmentResult("0",result);
//            requireActivity().getSupportFragmentManager().setFragmentResult("0",result);
        }
    }
